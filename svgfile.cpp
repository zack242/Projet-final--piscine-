...
template<typename T>
std::string attribr(std::string name, T val)
{
    std::ostringstream oss;
    oss << name << "=\"" <<"rotate( "<< val << ") \" ";
    return oss.str();
...
template<typename T>
std::string attribv(std::string name, T val)
{
    std::ostringstream oss;
    oss << name << "=\" scale(-1,0) \" ";
    return oss.str();
...
void Svgfile::addTriangle(double x1, double y1, double x2, double y2,
                          double x3, double y3, std::string colorFill,                          double thickness, std::string colorStroke)
{
...
void Svgfile::addRectangle(double x1, double y1, double x2, double y2, std::string colorFill,double rot)
{
    m_ostrm << "<rect "
            << attrib("x", x1)
            << attrib("y", y1)
